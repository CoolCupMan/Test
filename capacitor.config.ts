...
const config: CapacitorConfig = {
  ...
  // (app.binarycore.editor3dx, editor3dx2, editor3dx3, editor3dx4, or
  ...
  appId: "app.binarycore.editor3dx5",
  ...
  plugins: {
    GoogleAuth: {
      ...
      // package name (app.binarycore.editor3dx5) + signing certificate SHA-1 —
