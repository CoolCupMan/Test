...
const config: CapacitorConfig = {
  ...
  // editor3dx5, editor3dx6, editor3dx7, or whatever the original
  ...
  appId: "app.binarycore.editor3dx8",
  ...
  plugins: {
    GoogleAuth: {
      ...
      // package name (app.binarycore.editor3dx8) + signing certificate SHA-1 —
