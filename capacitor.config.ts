...
const config: CapacitorConfig = {
  ...
  // (app.binarycore.editor3dx, editor3dx2, editor3dx3, or whatever the
  ...
  appId: "app.binarycore.editor3dx4",
  ...
  plugins: {
    GoogleAuth: {
      ...
      // package name (app.binarycore.editor3dx4) + signing certificate SHA-1 —
