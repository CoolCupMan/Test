...
const config: CapacitorConfig = {
  ...
  // editor3dx10, editor3dx11, editor3dx12, editor3dx13, or whatever the
  ...
  appId: "app.binarycore.editor3dx14",
  ...
  plugins: {
    GoogleAuth: {
      ...
      // package name (app.binarycore.editor3dx14) + signing certificate SHA-1 —
