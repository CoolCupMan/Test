...
const config: CapacitorConfig = {
  ...
  // editor3dx10, editor3dx11, editor3dx12, editor3dx13, editor3dx14, or
  ...
  appId: "app.binarycore.editor3dx15",
  ...
  plugins: {
    GoogleAuth: {
      ...
      // package name (app.binarycore.editor3dx15) + signing certificate SHA-1 —
