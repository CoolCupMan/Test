...
const config: CapacitorConfig = {
  ...
  // editor3dx10, editor3dx11, or whatever the original binarycore3d2x...
  ...
  appId: "app.binarycore.editor3dx12",
  ...
  plugins: {
    GoogleAuth: {
      ...
      // package name (app.binarycore.editor3dx12) + signing certificate SHA-1 —
