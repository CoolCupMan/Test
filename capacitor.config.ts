...
const config: CapacitorConfig = {
  ...
  // editor3dx5, editor3dx6, editor3dx7, editor3dx8, editor3dx9, or
  ...
  appId: "app.binarycore.editor3dx10",
  ...
  plugins: {
    GoogleAuth: {
      ...
      // package name (app.binarycore.editor3dx10) + signing certificate SHA-1 —
