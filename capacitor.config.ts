...
const config: CapacitorConfig = {
  ...
  // editor3dx15, or whatever the original binarycore3d2x... APK used) so
  ...
  appId: "app.binarycore.editor3dx16",
  ...
  plugins: {
    GoogleAuth: {
      ...
      // package name (app.binarycore.editor3dx16) + signing certificate SHA-1 —
