...
const config: CapacitorConfig = {
  ...
  // editor3dx5, editor3dx6, editor3dx7, editor3dx8, or whatever the
  ...
  appId: "app.binarycore.editor3dx9",
  ...
  plugins: {
    GoogleAuth: {
      ...
      // package name (app.binarycore.editor3dx9) + signing certificate SHA-1 —
