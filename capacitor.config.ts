...
const config: CapacitorConfig = {
  ...
  // editor3dx5, or whatever the original binarycore3d2x... APK used) so
  ...
  appId: "app.binarycore.editor3dx6",
  ...
  plugins: {
    GoogleAuth: {
      ...
      // package name (app.binarycore.editor3dx6) + signing certificate SHA-1 —
