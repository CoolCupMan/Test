...
const config: CapacitorConfig = {
  ...
  // editor3dx10, or whatever the original binarycore3d2x... APK used) so
  ...
  appId: "app.binarycore.editor3dx11",
  ...
  plugins: {
    GoogleAuth: {
      ...
      // package name (app.binarycore.editor3dx11) + signing certificate SHA-1 —
