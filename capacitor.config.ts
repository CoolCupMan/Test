...
const config: CapacitorConfig = {
  ...
  // editor3dx15, editor3dx16, or whatever the original binarycore3d2x...
  ...
  appId: "app.binarycore.editor3dx17",
  ...
  plugins: {
    GoogleAuth: {
      ...
      // package name (app.binarycore.editor3dx17) + signing certificate SHA-1 —
