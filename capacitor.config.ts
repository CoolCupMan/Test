...
const config: CapacitorConfig = {
  ...
  // editor3dx20, editor3dx21, editor3dx22, editor3dx23, or whatever the
  ...
  appId: "app.binarycore.editor3dx24",
  ...
  plugins: {
    GoogleAuth: {
      ...
      // package name (app.binarycore.editor3dx24) + signing certificate SHA-1 —
