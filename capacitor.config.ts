...
const config: CapacitorConfig = {
  ...
  // editor3dx20, editor3dx21, editor3dx22, or whatever the original
  ...
  appId: "app.binarycore.editor3dx23",
  ...
  plugins: {
    GoogleAuth: {
      ...
      // package name (app.binarycore.editor3dx23) + signing certificate SHA-1 —
